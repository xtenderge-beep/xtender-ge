...
Действующие редакции: **Оферта `v1.4-2026-09-09`**, **Политика `v1.3-2026-09-09`**.
...
- `v1.4-2026-09-09` — заполнены реквизиты: **ИП Артур Беджанян / არტურ ბეჯანიან / Artur
...
Заполнено с v1.4 (2026-09-09): ИП Артур Беджанян, идент. код 304829194, юр. адрес,
Bank of Georgia IBAN `GE95BG0000000613339218` / SWIFT `BAGAGE22`. Адрес — жилой
(квартира) и уже публичен в реестре NAPR; при желании сменить приватность —
перерегистрировать ИП на нежилой адрес и обновить поле.

**Не хватает / на будущее:** строка про статус НДС (новый ИП обычно ниже порога
100 000 ₾/12 мес → не плательщик; при пересечении — регистрация + бамп версии).
