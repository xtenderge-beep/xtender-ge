...
async function form(req,res) {
 ...
 res.render('admin/category-edit',{category,error:null,submitted:null});
}
async function save(req,res) {
 ...
 catch(error) { if(!error.status)throw error;res.status(error.status).render('admin/category-edit',{category,error:error.message,submitted:input}); }
}
...
module.exports={index,form,save,refreshOrder};
